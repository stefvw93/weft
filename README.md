...
Weft tracks Effect 4's prerelease line (beta, then rc). This release is built and tested against `effect@4.0.0-rc.117`; the peer range accepts newer 4.0 prereleases, which may contain upstream breaking changes.
